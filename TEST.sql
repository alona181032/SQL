...
Будет здорово, если Ваше решение оформлено в виде работающего кода и основательно протестировано на придуманных данных (код для наполнения данными тоже приложите).*/
    ...
    (18),(32),(26), (16),(45),(12),(56),(24),(66),(34);
   	INSERT INTO Users (age) VALUES
    (19),(33),(27), (20),(15),(11),(46),(23),(67),(37),(49),(35),(26), (20),(14),(31),(48),(22),(37),(34);
...
SELECT EXTRACT(MONTH FROM date) AS MONTH, AVG(PRICE)  FROM USERS AS U
...
SELECT EXTRACT(MONTH FROM date) AS MONTH, SUM(PRICE) as PRICE FROM USERS AS U
JOIN PURCHASES AS P ON U.USERID = P.USERID
JOIN ITEMS AS I ON P.ITEMID = I.ITEMID
WHERE AGE >= 35
GROUP BY month
...
SELECT U.USERID,I.ITEMID, ITEM_NAME, SUM(PRICE) AS PRICE, EXTRACT(YEAR FROM DATE) AS YEAR FROM USERS AS U
JOIN PURCHASES AS P ON U.USERID = P.USERID
JOIN ITEMS AS I ON P.ITEMID = I.ITEMID
...
select item_name, sum(i.price) as priceSum, (100 / (select sum(items.price) from items) * sum(i.price)) as persent 
FROM USERS AS U
JOIN PURCHASES AS P ON U.USERID = P.USERID
JOIN ITEMS AS I ON P.ITEMID = I.ITEMID
group by i.itemid 
